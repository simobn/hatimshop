...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::check()) {
            ...
            if (empty(Cart::where('user_id', str_replace('.', '', (string)request()->ip()))->where('order_id', null)->first())) {
                request()->session()->flash('error', 'Cart is Empty !');
                return back();
            }
        }
        ...
        $order_data['user_id'] = $request->user() ? $request->user()->id : Session::get('temp_id');
...
//        $order->fill($order_data);
        ...
        if (Auth::check()) {
            ...
            Cart::where('user_id', Session::get('temp_id'))->where('order_id', null)->update(['order_id' => $order->id]);
        }
