...
@section('main-content')
    <div class="card">
        <h5 class="card-header">Order <a href="{{route('order.pdf',[app()->getLocale(),$order->id])}}"
        ...
        <div class="card-body">
            @if($order)
                <table class="table table-striped table-hover">
                    @php
                        $shipping_charge=DB::table('shippings')->where('id',[app()->getLocale(),$order->shipping_id])->pluck('price');
                    @endphp
                    <thead>
                    <tr>
                        <th>S.N.</th>
